...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		onClick:            function() { return true; },   /* Onclick behaviour */
		...
		reflectionGET:      '&bgc=ffffff',             /* Pass variables via the GET method to the reflect_.php script */
		reflectionP:        0.5,            /* Height of the reflection in percent of the source image */
		reflectionPNG:      false,          /* Toggle reflect2.php or reflect3.php */
		reflectPath:        'http://www.taihepacking.com.hk/',             /* Path to the reflect_.php script */
